  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 7283521761511036378),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 8765704447149046136),
        name: 'title',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 7171803886300092224),
        name: 'date',
        type: 10,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 7438470878662292888),
        name: 'completed',
        type: 1,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 1335007812588653550),
        name: 'priorityIndex',
        type: 6,
        flags: 0,
      ),
...
/// [TodoDb] entity fields to define ObjectBox queries.
class TodoDb_ {
  /// See [TodoDb.id].
  static final id = obx.QueryIntegerProperty<TodoDb>(
    _entities[0].properties[0],
  );

  /// See [TodoDb.title].
  static final title = obx.QueryStringProperty<TodoDb>(
    _entities[0].properties[1],
  );

  /// See [TodoDb.date].
  static final date = obx.QueryDateProperty<TodoDb>(_entities[0].properties[2]);

  /// See [TodoDb.completed].
  static final completed = obx.QueryBooleanProperty<TodoDb>(
    _entities[0].properties[3],
  );

  /// See [TodoDb.priorityIndex].
  static final priorityIndex = obx.QueryIntegerProperty<TodoDb>(
